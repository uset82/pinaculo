    ...
    return (
      <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative min-w-max w-[700px] h-[850px] -mt-16">
            ...
            {Object.keys(localPositions).map((key) => {
              ...
              const yM = yKOL + step
                             const yPN = yM + step
               const yQRS = yPN + step
               // Place W and T on a row with an invisible circle gap below QRS, and X/Y/Z as the last row (horizontal)
               const yWT = yQRS + (step * 1.5) // Reduced gap to move WT up
               const yXYZ = yWT + (step * 0.8) // Reduced gap to move XYZ up
              const yRow = {
        ...
        <div className="w-full lg:w-1/3 lg:pl-6 mt-16">
